...
from utils.model_utils import get_model_parameters
...
class ModelWrapper(ContextManager):
    ...
    def __enter__(self):
        from utils.moler_inference_server import MoLeRInferenceServer

        self._inference_server = MoLeRInferenceServer(
            self.trained_model_path,
            num_workers=self.num_workers,
            max_num_samples_per_chunk=500 // self.beam_size-1,
        )
        return self
