...
from utils.training_utils import get_class_balancing_weights
from layers.moler_decoder import (
    MoLeRDecoder,
    MoLeRDecoderInput,
    MoLeRDecoderMetrics,
    MoLeRDecoderOutput,
)
from utils.epoch_metrics_logger import EpochMetricsLogger
    ...
    def run_on_data_iterator(
        ...
        with EpochMetricsLogger(
            ...
            for step, (batch_features, batch_labels) in enumerate(data_iterator):
                # print(step,batch_features, batch_labels)
