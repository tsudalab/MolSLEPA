...
from chem.atom_feature_utils import AtomFeatureExtractor
from chem.molecule_dataset_utils import BOND_DICT, featurise_atoms
from chem.rdkit_helpers import initialise_atom_from_symbol, get_atom_symbol
from chem.motif_utils import (
    MotifAnnotation,
    MotifAtomAnnotation,
    MotifVocabulary,
)
from chem.topology_features import calculate_topology_features
from chem.valence_constraints import (
    constrain_edge_choices_based_on_valence,
    constrain_edge_types_based_on_valence,
)
from preprocessing.cgvae_generation_trace import (
    calculate_dist_from_focus_to_valid_target,
)
from preprocessing.moler_generation_trace import (
    Edge,
...
class MoLeRDecoderState(object):
    ...
    def new_with_added_bond(
        ...
        bond_type_idx: int,
        bond_logprob: float,
        step_info: Optional[MoleculeGenerationEdgeChoiceInfo] = None,
    ) -> "MoLeRDecoderState":
        ...
        # print(old_state._focus_atom, target_atom_idx, EDGE_TYPE_IDX_TO_BOND_TYPE[bond_type_idx])
        # print('old',Chem.MolToSmiles(old_state._molecule), 'new_mol', Chem.MolToSmiles(new_mol))
        ...
        new_edge_selection_steps.append(step_info)
    ...
    def new_with_added_motif(
        ...
        # print('current_state._molecule', Chem.MolToSmiles(current_state._molecule))
